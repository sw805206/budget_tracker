...
| BL-021 | open | feature | Plans list is inert: cannot open/view any plan, and cannot delete a Draft. SCOPE §3 says a saved plan (Published or Draft) can be deleted — "simply gone" — never built. Related to BL-019 (no resume path into a Draft). | 2026-07-14 | |
